...
/*   Updated: 2022/12/16 14:54:39 by leo              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{.code = 2, .name = "ld", .argcode = true, .args = 0b110001000},
{.code = 3, .name = "st", .argcode = true, .args = 0b001101000},
{.code = 4, .name = "add", .argcode = true, .args = 0b001001001},
{.code = 5, .name = "sub", .argcode = true, .args = 0b001001001},
{.code = 6, .name = "and", .argcode = true, .args = 0b111111001},
{.code = 7, .name = "or", .argcode = true, .args = 0b111111001},
{.code = 8, .name = "xor", .argcode = true, .args = 0b111111001},
{.code = 9, .name = "zjmp", .argcode = false, .args = 0b010000000},
{.code = 10, .name = "ldi", .argcode = true, .args = 0b111011001},
{.code = 11, .name = "sti", .argcode = true, .args = 0b001111011},
{.code = 12, .name = "fork", .argcode = false, .args = 0b010000000},
{.code = 13, .name = "lld", .argcode = true, .args = 0b110001000},
{.code = 14, .name = "lldi", .argcode = true, .args = 0b111011001},
{.code = 15, .name = "lfork", .argcode = false, .args = 0b010000000},
{.code = 16, .name = "aff", .argcode = true, .args = 0b001000000},
};
